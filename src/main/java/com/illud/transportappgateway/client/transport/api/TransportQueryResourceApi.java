...
public interface TransportQueryResourceApi {
    ...
    @ApiOperation(value = "deleteProcessInstance", nickname = "deleteProcessInstanceUsingDELETE", notes = "", tags={ "transport-query-resource", })
    @ApiResponses(value = { 
        @ApiResponse(code = 200, message = "OK"),
        @ApiResponse(code = 204, message = "No Content"),
        @ApiResponse(code = 401, message = "Unauthorized"),
        @ApiResponse(code = 403, message = "Forbidden") })
    @RequestMapping(value = "/api/query/process-instances/{processInstanceId}",
    ...
    @ApiOperation(value = "getAllOpenBookings", nickname = "getAllOpenBookingsUsingGET", notes = "", response = OpenBookings.class, responseContainer = "List", tags={ "transport-query-resource", })
    @ApiResponses(value = { 
        @ApiResponse(code = 200, message = "OK", response = OpenBookings.class, responseContainer = "List"),
        @ApiResponse(code = 401, message = "Unauthorized"),
        @ApiResponse(code = 403, message = "Forbidden"),
